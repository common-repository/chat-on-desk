...
?>
<!-- Admin-accordion -->
<div class="ChatOnDesk_box">
    <div class="cod-accordion"><!-- cod-accordion -->
        <div class="accordion-section">
            <?php foreach ( $templates as $template ) { ?>
            <a class="cod-accordion-body-title" href="javascript:void(0)" data-href="#accordion_<?php echo esc_attr($template['status']); ?>">
            ...
            <div id="accordion_<?php echo esc_attr($template['status']); ?>" class="cod-accordion-body-content">
                ...
                <?php } ?>
                            ...
                            <div id="menu_<?php echo $template['status']; ?>" class="cod-menu-token" role="listbox"></div>
                        </td>
                    </tr>
                </table>
            </div>
