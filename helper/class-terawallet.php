...
class TeraWallet
{
    ...
    public static function addTabs( $tabs = array() )
    {
        ...
        $tabs['woocommerce']['inner_nav']['wc_woowalletnotification']['title']       = __('TeraWallet Notifications', 'chat-on-desk');
    ...
    {
        $defaults['chatondesk_general']['woo_wallet_credited_msg']          = 'off';
        $defaults['chatondesk_general']['sms_body_woo_wallet_credited_msg'] = '';
        $defaults['chatondesk_general']['woo_wallet_debited_msg']           = 'off';
        $defaults['chatondesk_general']['sms_body_woo_wallet_debited_msg']  = '';
        return $defaults;
    }
    ...
    {
        $woo_wallet_credited_msg          = chatondesk_get_option('woo_wallet_credited_msg', 'chatondesk_general', 'on');
        $sms_body_woo_wallet_credited_msg = chatondesk_get_option('sms_body_woo_wallet_credited_msg', 'chatondesk_message', sprintf(__('Dear %1$s, %2$s has been credited to your wallet. Current wallet balance is : %3$s.%4$sPowered by%5$swww.chatondesk.com', 'chat-on-desk'), '[username]', '[amount]', '[wallet_amount]', PHP_EOL, PHP_EOL));

        $woo_wallet_debited_msg          = chatondesk_get_option('woo_wallet_debited_msg', 'chatondesk_general', 'on');
        $sms_body_woo_wallet_debited_msg = chatondesk_get_option('sms_body_woo_wallet_debited_msg', 'chatondesk_message', sprintf(__('Dear %1$s, %2$s has been debited from your wallet. Current wallet balance is : %3$s.%4$sPowered by%5$swww.chatondesk.com', 'chat-on-desk'), '[username]', '[amount]', '[wallet_amount]', PHP_EOL, PHP_EOL));
        ...
        $templates['woo-wallet-credited']['checkboxNameId'] = 'chatondesk_general[woo_wallet_credited_msg]';
        $templates['woo-wallet-credited']['textareaNameId'] = 'chatondesk_message[sms_body_woo_wallet_credited_msg]';
        ...
        $templates['woo-wallet-debited']['checkboxNameId'] = 'chatondesk_general[woo_wallet_debited_msg]';
        $templates['woo-wallet-debited']['textareaNameId'] = 'chatondesk_message[sms_body_woo_wallet_debited_msg]';
    ...
    {
        if ('credit' === $type ) {
            $message                 = chatondesk_get_option('sms_body_woo_wallet_credited_msg', 'chatondesk_message', '');
            ...
            $message                = chatondesk_get_option('sms_body_woo_wallet_debited_msg', 'chatondesk_message', '');
            $message                = $this->parseSmsBody($user_id, $amount, $message);
            $woo_wallet_debited_msg = chatondesk_get_option('woo_wallet_debited_msg', 'chatondesk_general', 'on');
