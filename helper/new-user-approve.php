...
class NewUserApprove
{
    ...
    {
        $defaults['chatondesk_nua_general']['approved_notify'] = 'off';
        $defaults['chatondesk_nua_message']['approved_notify'] = '';
        $defaults['chatondesk_nua_general']['denied_notify']   = 'off';
        $defaults['chatondesk_nua_message']['denied_notify']   = '';
        return $defaults;
    }
    ...
    {
        // customer template.
        $current_val      = chatondesk_get_option('approved_notify', 'chatondesk_nua_general', 'on');
        $checkbox_name_id = 'chatondesk_nua_general[approved_notify]';
        $textarea_name_id = 'chatondesk_nua_message[approved_notify]';
        $text_body        = chatondesk_get_option('approved_notify', 'chatondesk_nua_message', SmsAlertMessages::showMessage('DEFAULT_NEW_USER_APPROVED'));
        ...
        // admin template.
        $current_val      = chatondesk_get_option('denied_notify', 'chatondesk_nua_general', 'on');
        $checkbox_name_id = 'chatondesk_nua_general[denied_notify]';
        $textarea_name_id = 'chatondesk_nua_message[denied_notify]';
        $text_body        = chatondesk_get_option('denied_notify', 'chatondesk_nua_message', SmsAlertMessages::showMessage('DEFAULT_NEW_USER_REJECTED'));
    ...
    public function sendSmsApproved( $user_id )
    {
        ...
        $chatondesk_nua_approved_notify  = chatondesk_get_option('approved_notify', 'chatondesk_nua_general', 'on');
        $chatondesk_nua_approved_message = chatondesk_get_option('approved_notify', 'chatondesk_nua_message', '');

        if ('on' === $chatondesk_nua_approved_notify && '' !== $chatondesk_nua_approved_message ) {
            do_action('cod_send_sms', $phone, $this->parseSmsBody($user_id, $chatondesk_nua_approved_message));
        }
    }
    ...
    public function sendSmsDenied( $user_id )
    {
        ...
        $chatondesk_nua_denied_notify  = chatondesk_get_option('denied_notify', 'chatondesk_nua_general', 'on');
        $chatondesk_nua_denied_message = chatondesk_get_option('denied_notify', 'chatondesk_nua_message', '');

        if ('on' === $chatondesk_nua_denied_notify && '' !== $chatondesk_nua_denied_message ) {
            do_action('cod_send_sms', $phone, $this->parseSmsBody($user_id, $chatondesk_nua_denied_message));
        }
    }
