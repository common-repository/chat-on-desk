 ...
 */
class EasyRegistration extends \ChatOnDesk\FormInterface
{
     ...
     * @var stirng
     */
    private $form_session_var = \ChatOnDesk\FormSessionVars::ER_DEFAULT_REG;
    ...
    {
        if (chatondesk_get_option('buyer_signup_otp', 'chatondesk_general') === 'on' ) {
            ...
            $html .= do_shortcode('[cod_verify phone_selector="#billing_phone" submit_selector= ".erf-button .btn" ]');
        }
        return $html;
    }
    ...
    public function routeData()
    {
        ...
        case 'chatondesk-er-ajax-verify':
    ...
    public function sendOtpErAjaxVerify( $getdata )
    {
        ...
        if (array_key_exists('user_phone', $getdata) && ! \ChatOnDesk\SmsAlertUtility::isBlank($getdata['user_phone']) ) {
            ...
            wp_send_json(\ChatOnDesk\SmsAlertUtility::_create_json_response('Enter a number in the following format : 9xxxxxxxxx', \ChatOnDesk\SmsAlertConstants::ERROR_JSON_TYPE));
        }
    }
