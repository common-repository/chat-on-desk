 ...
 * SA_Metform class.
 */
class SA_Metform extends \ChatOnDesk\FormInterface
{
    ...
    public function addSmsalertSetting()
    {
        echo'<li role="presentation">
				...
				class="top">Chat On Desk</a>
            </li>'; 
    }
    
    /**
     * Add Chat On Desk contant tab
     *    
     * @return void
     */
				...
				<div class="attr-modal-body" id="metform_form_modal_body">
                    <div class="mf-input-group">
							<label class="attr-input-label"  >
								...
								<span>ChatOnDesk Notification:</span>
							</label> 
                    </div>
    ...
    {
        $chatondesk_notification   = isset($form_settings['mf_sms_status']);
        if (! empty($chatondesk_notification)) {            
