 ...
 */
class ProfileRegistrationForm extends \ChatOnDesk\FormInterface
{
     ...
     * @var stirng
     */
    private $form_session_var = \ChatOnDesk\FormSessionVars::PR_DEFAULT_REG;
    ...
    public static function wppbPhoneAddFormFormBuilder( $output, $form_location = '' )
    {
        if ('register' === $form_location ) {
            ...
            echo do_shortcode('[cod_verify id="form1" phone_selector="#billing_phone" submit_selector= "register" ]');
        }
    }
