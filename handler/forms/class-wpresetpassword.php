 ...
 */
class WPResetPassword extends \ChatOnDesk\FormInterface
{
     ...
     * @var stirng
     */
    private $form_session_var = \ChatOnDesk\FormSessionVars::WP_DEFAULT_LOST_PWD;
    ...
    {
        if (! empty($_REQUEST['option']) && sanitize_text_field(wp_unslash($_REQUEST['option'])) === 'chatondesk-change-password-form' ) {
    ...
    public static function isFormEnabled()
    {
        ...
        return ( $islogged && chatondesk_get_option('reset_password', 'chatondesk_general') === 'on' ) ? true : false;
    }
    ...
    /**
     * Start ChatOnDesk Reset Password Process
     *
    ...
    public function fetchPhoneAndStartVerification( $user, $key, $username, $password, $phone_number )
    {
        ...
        chatondesk_site_challenge_otp($user, $username, null, $phone_number, 'phone', $password, \ChatOnDesk\SmsAlertUtility::currentPageUrl(), false);
    }
