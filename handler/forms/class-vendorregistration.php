 ...
 */
class VendorRegistrationForm extends \ChatOnDesk\FormInterface
{
     ...
     * @return stirng
     */
    private $form_session_var = \ChatOnDesk\FormSessionVars::PV_DEFAULT_REG;
    ...
    public static function vendorsRegCustomFields()
    {
        ...
        echo '<script>			jQuery(".wcpv-shortcode-registration-form").addClass("cod-wcpv-form");
		</script>';  
        echo do_shortcode('[cod_verify id="" phone_selector="#wcpv-billing-phone" submit_selector= ".cod-wcpv-form .button:not(#cod_verify_otp)" ]');
    }
    ...
    public static function isFormEnabled()
    {
        ...
        return ( chatondesk_get_option('buyer_signup_otp', 'chatondesk_general') === 'on' && $islogged ) ? true : false;
    }
