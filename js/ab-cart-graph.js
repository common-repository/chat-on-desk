...
$cod(document).ready(
    function () {
        ...
        $cod('#chatondesk_date_range').change(
            function () {
      
                var group_name  = $cod('#chatondesk_date_range').val();
                if ($cod(this).val() == "custom") {
                      document.getElementById("cod_start_end_date_div").style.display = "block";
                }
                if ($cod(this).val() != "custom" ) {
                    document.getElementById("cod_start_end_date_div").style.display = "none";
                }
            }
        );
